 ...
 * Objective: Take string of gifts as argument, return string representing warehouse
 *
 * @param {string} gifts - The list of gifts to be organized
 * @returns {string} - The organized representation of the gifts
 */
function organizeGifts(gifts) {
  // Use regex to match quantities and symbols in input string
  ...
  return matches
    .map(([, quantity, symbol]) => {
      ...
      // Join all the organised representations to form final result
